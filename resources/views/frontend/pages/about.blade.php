<div class="w-screen max-w-full bg-gradient-to-b from-[#f8f4ee] to-white ">
    <div class="flex flex-col justify-start space-y-6 pt-[80px]  ml-16 mr-16 mb-[10vh]">
        ...
        <div class="block md:hidden text-[20px] sm:text-[20px] md:text-[24px] lg:text-[28px] xl:text-[32px] 2xl:text-[36px] mr-4 transition-opacity duration-[1500ms] ease-in-out fade-in excerpt text-black mt-[2%]   ">
            {!! strip_tags($page->getTranslatedAttribute('excerpt', $lang)) !!}
        </div>

        {{-- Desktop: conteúdo HTML --}}
        <div class="hidden md:block text-[20px] sm:text-[20px] md:text-[24px] lg:text-[28px] xl:text-[32px] 2xl:text-[36px]  transition-opacity duration-[1500ms] ease-in-out fade-in excerpt text-black mt-[2%]  ">
